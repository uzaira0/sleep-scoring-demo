...
class DatabaseManager:
    ...
    def _row_to_sleep_metrics(self, row: sqlite3.Row) -> SleepMetrics:
        ...
        return SleepMetrics(
            ...
            algorithm_type=AlgorithmType(safe_get(DatabaseColumn.ALGORITHM_TYPE) or AlgorithmType.COMBINED),
    ...
    def _dict_to_sleep_metrics(self, data: dict[str, Any]) -> SleepMetrics:
        ...
        return SleepMetrics(
            ...
            algorithm_type=AlgorithmType(data.get("Sleep Algorithm", AlgorithmType.COMBINED)),
            daily_sleep_markers=daily_markers,
